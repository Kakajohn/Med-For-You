  ...
  return (
   ...
   {/* <h1 id='header'>Familial Adenomatous Polyposis</h1> */}
    <h2 id='define-new-section'>Overview</h2>
                    ...
                    {/* <button id='read' onClick={showmore} ref={ref}>Click to read more...</button><button id='less' onClick={showless} ref={ref}>Click to read less...</button>
                  {click && ( */}
                  <span id='more'>  <h1 id='define-new-section'>Symptoms & Causes</h1>
                    <p>
...
export default FamilialAdenomatous