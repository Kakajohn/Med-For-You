...
import { FaPlusCircle,FaFileImage,FaBox,FaPlane } from "react-icons/fa";
...
<div className='message-send-section'>
     ...
     <div className='message-type'>
          <input type="text" onChange={inputHendle} name='message' id='message' placeholder='Aa'
               className='form-control' value={newMessage} />
