      ...
      <div className='card text-light border-danger border-2' style={{ backgroundColor: '#151515' }}>
        <div className='card-body'>
          <p>
            ...
            provide them with a set of facilities (services) and they can use these services without having to know
            or deal with the technical details of the implementation, for example with the transmission rate
            provided by the telecommunications organization or with the protocols of a network.
          </p>
          <p>
            ...
            from another hospital and provide advice to non-specialized doctors or doctors of other specialties.
            This is crucial in the case of remote health centers as well as in dealing with emergencies. The
            following options are also offered to the doctor:
          </p>
          <ul>
      ...
      <div className='card text-light border-danger border-2' style={{ backgroundColor: '#151515' }}>
        <div className='card-body'>
          <p>
            ...
            pulse, oxygen levels in the blood can be life issues that need to be diagnosed and treated immediately
            by our doctor. What if we are alone at home or our own are unable to help us and the distance from the
          ...
          <p>
            ...
            boards (chips) in combination with the increase of the data transmission speed through telephone,
            network or wireless networks. The spread of modern technology to the general public has familiarized
            patients with the use of the internet and has brought them closer to current events and developments in
            medicine. The benefits of home patient monitoring are many.
          </p>
          <ul>
            <li>
